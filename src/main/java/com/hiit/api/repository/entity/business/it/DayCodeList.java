...
public enum DayCodeList {
	...
	DayCodeList(String code, String days) {
		this.code = code;
		this.days = days;
	}

	public static DayCodeList of(String code) {
		for (DayCodeList dayCode : DayCodeList.values()) {
			if (dayCode.getCode().equals(code)) {
				return dayCode;
			}
		}
		throw new IllegalArgumentException("Unknown DayCodeList code: " + code);
	}
}
