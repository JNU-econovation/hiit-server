...
class UpdateMemberStatDeleteInItEventListenerTest {
	...
	@Test
	@DisplayName("이벤트를 통해 잇 삭제시 회원 통계 문서 업데이트")
	void handle() {
		...
		assertThat(resource.getItWithCountStats().get(inItId)).isNull();
	}
}
