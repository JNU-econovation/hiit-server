...
@ContextConfiguration(
		classes = {
			HitItTimeInfoService.class,
			ItTimeInfoExecutorManager.class,
			RegisteredItTimeInfoExecutor.class,
			RepositoryConfig.class
		})
class HitItTimeInfoServiceTest {

	@InjectMocks @Autowired private HitItTimeInfoService hitItTimeInfoService;
	...
	void read_registered_type_it() {
		...
		// when
		HitItTimeInfo res = hitItTimeInfoService.read(relationId);
