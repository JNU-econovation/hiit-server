...
public class EndItDescription {
	...
	public static FieldDescriptor[] browseEndIt() {
		return new FieldDescriptor[] {
			...
			fieldWithPath("data.startTime").type(JsonFieldType.NUMBER).description("종료 잇 시작 시간"),
			fieldWithPath("data.endTime").type(JsonFieldType.NUMBER).description("종료 잇 종료 시간"),
	...
	public static FieldDescriptor[] readEndIts() {
		return new FieldDescriptor[] {
			...
			fieldWithPath("data.endIts[].startTime").type(JsonFieldType.NUMBER).description("종료 잇 시작 시간"),
			fieldWithPath("data.endIts[].endTime").type(JsonFieldType.NUMBER).description("종료 잇 종료 시간"),
