...
|-------------------------------------------|-----------|-----------------------|------------------------|
| 참여 중인 잇 Id는 음수일 수 없다.                     | 400       | request.id.invalid    | 잘못된 요청입니다.             |
| 윗의 내용은 공백 포함 20자를 넘어갈 수 없다.               | 400       | request.title.invalid | 잘못된 요청입니다.             |
| 윗의 내용은 공백 일 수 없다.                         | 400       | request.title.invalid | 잘못된 요청입니다.             |
| 참여 중인 잇에 대한 윗은 일별로 하나 이상 작성할 수 없다.        | 400       | fail.request          | 잘못된 요청입니다.             |
| 참여 중인 잇의 시작 시간 이전과 종료 시간 이후에는 윗을 작성 수 없다. | 400       | fail.request          | 잘못된 요청입니다.             |
| 참여 중이지 않은 잇에 대한 윗은 작성할 수 없다.              | 403       | access.denied         | 접근 권한이 없어요.            |
| 타인의 참여 잇 접근하는 경우                          | 403       | access.denied         | 접근 권한이 없어요.            |
| 참여 중인 잇 Id는 존재하는 Id이어야 한다.                | 404       | resource.notfound     | 요청과 일치하는 결과를 찾을 수 없어요. |
...
| 상황                                         | http_code | code               | message                |
|--------------------------------------------|-----------|--------------------|------------------------|
| 윗 Id는 음수일 수 없다.                            | 400       | request.id.invalid | 잘못된 요청입니다.             |
| 참여 중인 잇의 시작 시간 이전과 종료 시간 이후에는 윗을 삭제할 수 없다. | 400       | request.invalid    | 잘못된 요청입니다.             |
| 타인의 윗 접근하는 경우                              | 403       | access.denied      | 접근 권한이 없어요.            |
| 윗이 등록되어 있지 않은 경우                           | 404       | resource.notfound  | 요청과 일치하는 결과를 찾을 수 없어요. |
| 윗 Id는 존재하는 Id이어야 한다.                       | 404       | resource.notFound  | 요청과 일치하는 결과를 찾을 수 없어요. |
